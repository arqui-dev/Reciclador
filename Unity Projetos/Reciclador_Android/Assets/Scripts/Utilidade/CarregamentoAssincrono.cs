...
public class CarregamentoAssincrono : MonoBehaviour
{
	...
	void PegarEmpreendimentos()
	{
		//GerenciadorEmpreendimentos.listaEmpreendimentosEstatica = GerenciadorCarregamento.CarregarEmpreendimentos();
		GerenciadorEmpreendimentos.listaEmpreendimentosEstatica = CarregarEmpreendimentos();
		pronto = true;
	}
	...
	const int quantidadeTiposRecicladoras = 4;
	...
	string caminhoEmpreendimentos = "empreendimentos";

	// Strings usadas para reconhecimento do parser
	string parseEmpreendimento = "empreendimento";
	string parseNome = "nome";
	string parseDescricao = "descricao";
	string parseNivelMaximo = "nivelmaximo";
	string parseNivelEmpreendimento = "nivelempreendimento";
	string parseValorVenda = "valorvenda";
	string parseExperiencia = "experiencia";
	string parseVelocidadeAparecerLixo = "velocidadeaparecerlixo";
	string parseLimiteFila = "limitefila";
	string parseLixoMinimo = "lixominimo";
	string parseVelocidadeReciclagem = "velocidadereciclagem";
	string parseDinheiroGerado = "dinheirogerado";
	string parseSeparacaoAutomatica = "separacaoautomatica";
	string parsePoderJogador = "poderjogador";
	string parsePreco = "preco";
	string parseNivelSustentabilidade = "nivelsustentabilidade";
	string parseEmpreendimentosConstruidos = "empreendimentosconstruidos";
	string parseFimEmpreendimento = "fimempreendimento";

	int porcentagemAtual = 0;
	int porcentagemMaxima = 1;
	...
	Empreendimento [] CarregarEmpreendimentos(
		TipoCarregamento tipo = TipoCarregamento.InternoResources)
	{
		...
		Debug.Log("Carregamento iniciado 0%");
		...
		Debug.Log("Pegou arquivo e separou linhas 1%");
	...
	string CarregarStringDeResources(string filepath)
	{
	...
	string [] RemoverLinhasComentarios(string empreendimento)
	{
		if (string.IsNullOrEmpty(empreendimento))
			return null;

		Debug.Log("Remover Linhas - "+"Antes de separar em linhas: "+tempo);
		//string [] linhas = empreendimento.Split(separadorLinhas,System.StringSplitOptions.None);
		string [] linhas = ArquivoStrings.empreendimentosLinhas;
		Debug.Log("Remover Linhas - "+"Depois de separar em linhas/antes do loop: "+tempo);
		...
		Debug.Log("Remover Linhas - "+"Finalizado: "+tempo);
